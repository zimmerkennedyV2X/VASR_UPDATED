...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="vehicle-profile-container">
        <div class="vehicle-profile-page">
            <asp:FormView ID="FormView1" runat="server" DataKeyNames="ID" DataSourceID="SqlDataSource1" Width="100%">
                <EditItemTemplate>
                    <div class="upadate-panel-container col-md-12">
                        <div class="upadate-panel panel panel-default">
                            <div class="upadate-panel-content panel-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="AdminNumberTextBox" CssClass="form-control" runat="server" Text='<%# Bind("AdminNumber") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .7); color: rgba(59,141,65,.819);"/>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="PlateNumberTextBox" CssClass="form-control" runat="server" Text='<%# Bind("PlateNumber") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .7); color: rgba(59,141,65,.819);"/>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="ModelTextBox" runat="server" CssClass="form-control" Text='<%# Bind("Model") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .7); color: rgba(59,141,65,.819);"/>
                                ...
                                <h5 class="vehicleProfile headers"><strong>Current Records</strong></h5>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="CurrentMileageTextBox" CssClass="form-control" runat="server" Text='<%# Bind("CurrentMileage") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .7); color: rgba(59,141,65,.819);"/>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="DDLFuelLevel" CssClass="form-control" runat="server" SelectedValue='<%# Bind("CurrentFuelLevel") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .7); color: rgba(59,141,65,.819);">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="DDLVehicleCode" CssClass="form-control" runat="server" SelectedValue='<%# Bind("VehicleCode") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .7); color: rgba(59,141,65,.819);">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:CheckBox ID="VehicleStatusCheckBox" CssClass="form-control" runat="server" Checked='<%# Bind("VehicleStatus") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .7); color: rgba(59,141,65,.819);"/>
                                        </div>
                                    </div>
                                </div>

                                <h5 class="vehicleProfile headers"><strong>Vehicle Maintenance</strong></h5>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="RegExpiryTextBox" CssClass="form-control" runat="server" Text='<%# Bind("RegExpiry","{0:d}") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .7); color: rgba(59,141,65,.819);"/>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="DueMileageTextBox" CssClass="form-control" runat="server" Text='<%# Bind("DueMileage") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .7); color: rgba(59,141,65,.819);"/>
                                ...
                                <h5 class="vehicleProfile headers"><strong>Vehicle POC and Location </strong></h5>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="DesignatedOperatorTextBox" CssClass="form-control" runat="server" Text='<%# Bind("DesignatedOperator") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .7); color: rgba(59,141,65,.819);"/>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="PhoneNumberTextBox" CssClass="form-control" runat="server" Text='<%# Bind("PhoneNumber") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .7); color: rgba(59,141,65,.819);"/>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="VehicleLocationTextBox" CssClass="form-control" runat="server" Text='<%# Bind("VehicleLocation") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .7); color: rgba(59,141,65,.819);"/>
                        ...
                        <asp:LinkButton ID="CancelButton" CssClass="btn btn-success btn-md" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" style="margin-right: 1.2rem;border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(5,28,60,.8)"/>
                        <asp:LinkButton ID="UpdateButton" CssClass="btn btn-success btn-md" runat="server" CausesValidation="True" CommandName="Update" Text="Update Vehicle" style="box-shadow: 5px 5px 10px 0 #000000; border: none; background-color: rgba(59,141,65,.819)"/>
                    </div>
                </EditItemTemplate>
                            ...
                            <div class="">
                                <div class="col-sm-12">
                                    <div class="col-xs-12 col-sm-8">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <small>Notes:</small>
                                                <asp:TextBox CssClass="form-control" Enabled="false" Font-Bold="true" runat="server" ID="Label4" Text='<%# Bind("Comments") %>' style="width:220px;border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .9); color: rgba(59,141,65,.819)"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-4 text-center">
                                        <figure>
                                            <asp:Repeater ID="lvVehiclePhotos" runat="server">
                                                <HeaderTemplate>
                                                    <div class="carousel slide" id="itemPlaceholderContainer" data-ride="carousel"><%--<<<<<  Image Shadowing  <<<<<--%>
                                ...
                                <div class="col-xs-12 divider text-center">
                                    <div class="col-xs-12 col-sm-4 emphasis">
                                        ...
                                        <asp:LinkButton ID="EditButton" CssClass="btn btn-success btn-block" style="box-shadow: 5px 5px 10px 0 #000000; border: none; background-color: rgba(59,141,65,.819)" runat="server" CausesValidation="False" CommandName="Edit"><span class="glyphicon glyphicon-pencil"></span> Edit Vehicle</asp:LinkButton>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-4 emphasis">
                                        ...
                                        <asp:LinkButton ID="lnkUploadPhotos" CssClass="btn btn-info btn-block" style="box-shadow: 5px 5px 10px 0 #000000; border: none; background-color: rgba(29,104,162,.819)" OnClick="lnkUploadPhotos_Click" runat="server"><span class="glyphicon glyphicon-camera"></span>&nbsp;Upload Vehicle Photos</asp:LinkButton>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-4 emphasis">
                                        ...
                                        <div class="btn-group dropup btn-block">
                                            <button type="button" class="btn btn-primary" style="box-shadow: 5px 5px 10px 0 #000000; border: none; background-color: rgba(5,28,60,.8)"><span class="fa fa-gear"></span>Options </button>
                                            <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" style="box-shadow: 5px 5px 10px 0 #000000; border: none; background-color: rgba(5,28,60,.8)">
            ...
            <div class="usage-records-container row">
                <div class="usage-table col-md-6">
                    ...
                    <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource2">
                        ...
                        <LayoutTemplate>
                            <table runat="server" style="width: 100%">
                                <tr runat="server">
                                    <td runat="server">
                                        <table id="itemPlaceholderContainer" class="table table-sm table-striped table-hover " runat="server" border="0" style=" box-shadow: 0 0 10px 0 #000000">
                                            <tr runat="server" style="background-color: rgba(0, 1, 1, .9);">
                                        
                                                <%-------Add sorting function (JaQuan)-------%>

                                                <th runat="server">
                                                    <asp:LinkButton ID="lnkSortFullName" runat="server" CommandName="Sort" CommandArgument="FullName" style="text-decoration:none; color: rgba(59,141,65,.819)">Operator <span style="color: #909091;">  ↑↓</span></asp:LinkButton></th>
                                                <th runat="server">
                                                    <asp:LinkButton ID="lnkSortStartDate" runat="server" CommandName="Sort" CommandArgument="StartDateAndTime" style="text-decoration:none; color: rgba(59,141,65,.819)">Record Date/Time <span style="color: #909091;">↑↓</span></asp:LinkButton></th>
                                                <th runat="server">
                                                    <asp:LinkButton ID="lnkSortMileage" runat="server" CommandName="Sort" CommandArgument="EndMileage" style="text-decoration:none; color: rgba(59,141,65,.819)">End Mileage <span style="color: #909091;">↑↓</span></asp:LinkButton></th>
                                            </tr>
                ...
                <div class="documnets-container col-md-6">
                    <div class="documents-header">
                        ...
                        <div class="col-md-6 text-right">
                            <asp:Button ID="btnUploadWeekly" CssClass="btn btn-warning btn-xs" Text="Upload Files" OnClick="btnUploadWeekly_Click" runat="server" style="box-shadow: 5px 5px 10px 0 #000000;" />
                        </div>
                    </div>
    ...
    <style>
        ...
        .upadate-panel-container, .upadate-panel{
            border: none;
        }
        .upadate-panel{
            background-color: rgba(0, 1, 1, .9);
        }
        .upadate-panel-content{
