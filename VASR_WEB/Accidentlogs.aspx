            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="form-inline">
                        ...
                        <asp:TextBox ID="txtfilterAccidentRecord" placeholder="Enter Number" runat="server" CssClass="form-control" OnTextChanged="txtfilterAccidentRecord_TextChanged" AutoPostBack="true" style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; margin-right: 12px; background-color: rgba(0, 1, 1, .9); color: rgba(59,141,65,.819);"></asp:TextBox>
                        <asp:Button ID="btnSearchAccidentRecord" runat="server" Text="Search" CssClass="btn btn-primary" style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(5,28,60,.8)"/>
                    </div>
                </div>
