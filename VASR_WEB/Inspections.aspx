        ...
        <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <asp:TextBox ID="inspectionDateFilter" AutoPostBack="True" OnTextChanged="inspectionDateFilter_TextChanged" CssClass="form-control" TextMode="date" runat="server" style="box-shadow: 5px 5px 10px 0 #000000; border: none; background-color: rgba(0, 1, 1, .8); color: rgba(59,141,65,.819)"></asp:TextBox>
                </div>

                <div class="col-md-6 text-right" style="margin-top: 26px">
                    <asp:LinkButton ID="redirectToInspectionLogs" runat="server" CssClass="btn btn-info btn-sm" OnClick="redirectToInspectionLogs_Click" style="margin-right: 12px; background-color: rgba(29,104,162,.819); border: 1px solid rgba(29,104,162,.7); box-shadow: 5px 5px 10px 0 #000000">Inspection Logs</asp:LinkButton>
                    <button class="btn btn-success btn-sm" id="exportExelInspections" runat="server" onserverclick="exportExelInspections_ServerClick" style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; margin-right: 12px; background-color: rgba(59,141,65,.819)"><span class="glyphicon glyphicon-export"></span> Export Excel</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1">
                ...
                <ItemTemplate>
                    <tr class="<%# GetColor(Eval("InspectionDateCompleted"))  %>" style="box-shadow: 0 0 10px 2px #000000; background-color: rgba(0, 1, 1, .819); color: rgba(59,141,65,.819)">
                        <td>
            ...
            <asp:ListView ID="ListView2" runat="server" DataKeyNames="ID" DataSourceID="SqlDataSource2">
                ...
                <ItemTemplate>
                    <tr style="background-color: rgba(0, 1, 1, .819); color: rgba(59,141,65,.819)">
                        <td>
                            <a class="btn btn-info btn-xs" style="margin-top: 6px; background-color: rgba(29,104,162,.819); border: 1px solid rgba(29,104,162,.7); box-shadow: 0 0 10px 2px rgba(29,104,162,.7)" href="VehicleInspections.aspx?ID=<%# Eval("ID") %>&VehicleID=<%# Eval("VehicleID") %>"><span class="glyphicon glyphicon-eye-open"></span>&nbsp;Inspect</a>
                        </td>
                        <td>
                            <asp:Label ID="AdminNumberLabel" Font-Size="Smaller" runat="server" Text='<%# Eval("AdminNumber") %>' />
                        </td>
                ...
                <LayoutTemplate>
                    <table runat="server" style="width: 100%">
                        <tr runat="server">
                            <td runat="server">
                                <table id="itemPlaceholderContainer" class="table table-striped table-hover " runat="server" border="0" style="box-shadow: 0 0 10px 2px #000000">
