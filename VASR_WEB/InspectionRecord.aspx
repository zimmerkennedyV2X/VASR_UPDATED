...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default" style="margin: 62px 0 37px 0; border: none; box-shadow: 0 0 10px 2px #000000; background-color: rgba(0, 1, 1, .819); color: rgba(59,141,65,.819)">
                <div class="panel-body">
                    <asp:FormView ID="FormView1" runat="server" DataKeyNames="ID" DataSourceID="SqlDataSource1" Width="100%">
                        <ItemTemplate>
                            ...
                            <div class="well well-sm" style=" background-color: rgba(0, 1, 1, .819)">
                                <div class="row">
                                    <div class="col-md-3">
                                        <small>Admin #:</small>
                                        <br/>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <table class="table table-striped table-hover w-auto" >
                                        <thead>
                                            <tr style=" background-color: rgba(0, 1, 1, .819)">
                                        ...
                                        <tbody>
                                            <tr style=" background-color: rgba(0, 1, 1, .0)">
                                    ...
                                    <small>Inspector Comments/Notes:</small>
                                    <br />
                                ...
                                <div class="col-md-6">
                                    <br />
                                    <div class="panel panel-default" style="border: none; background-color: rgba(0, 1, 1, .1)">
                                        <div class="panel-heading" style="background-color: rgba(0, 1, 1, .7); border: none">
                                            <div class="row">
                                                <div class="col-sm-8">
                                                    <h5 class="" style="color: rgba(59,141,65,.819)"><strong>Attached Photos and Documents</strong></h5>
                                                </div>
                                                <div class="col-sm-4 text-right">
                                                    <asp:Button Text="Incident Report" ID="Button1" OnClick="btnManageFiles_Click" CssClass="btn btn-info btn-xs" runat="server" style="margin-top: 6px; background-color: rgba(29,104,162,.819); border: 1px solid rgba(29,104,162,.7); box-shadow: 0 0 10px 2px rgba(29,104,162,.7)"/>
