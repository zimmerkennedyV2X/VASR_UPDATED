    ...
    <body>
        <form id="form1" runat="server">
            ...
            <div class="container">
                ...
                <div class="row dispatchPanel">
                    <div class="col-lg-11 col-md-11 col-sm-8 col-xs-9 imdvasr-tab-container" style="margin: 0; width: 60%">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 imdvasr-tab-menu">
                            <div class="list-group">
                                ...
                                <a href="#" class="list-group-item  text-center logo-container" style="background: #53565a">
                                    <img class="V2X" src="../img/V2X_Color.png" />
                                </a>
                            </div>
                        </div>
                ...
                <footer class="row" style="margin-left: 0; margin-right: 0">
                    <hr />
