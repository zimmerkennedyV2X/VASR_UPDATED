...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="new-vehicle-container">
        <div class="new-vehicle-page">
            <h3 class="new-vehicle-header"><strong>+ Add a New Vehicle to the Fleet</strong></h3>

            <asp:FormView ID="FormView1" runat="server" DataKeyNames="ID" DefaultMode="Insert" DataSourceID="SqlDataSource1" Width="60%">
                <InsertItemTemplate>
                    <div class="col-md-12">
                        <div class="new-vehicle-panel panel panel-default">
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="DDLSection" CssClass="form-control" runat="server" SelectedValue='<%# Bind("Section") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .9); color: rgba(59,141,65,.819);">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="AdminNumberTextBox" CssClass="form-control" runat="server" Text='<%# Bind("AdminNumber") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .9); color: rgba(59,141,65,.819);"/>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="PlateNumberTextBox" CssClass="form-control" runat="server" Text='<%# Bind("PlateNumber") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .9); color: rgba(59,141,65,.819);"/>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="ModelTextBox" runat="server" CssClass="form-control" Text='<%# Bind("Model") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .9); color: rgba(59,141,65,.819);"/>
                                ...
                                <h5 class="new-vehicle-headers"><strong>Current Records</strong></h5>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="CurrentMileageTextBox" CssClass="form-control" runat="server" Text='<%# Bind("CurrentMileage") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .9); color: rgba(59,141,65,.819);"/>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="DDLFuelLevel" CssClass="form-control" runat="server" SelectedValue='<%# Bind("CurrentFuelLevel") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .9); color: rgba(59,141,65,.819);">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="DDLVehicleCode" CssClass="form-control" runat="server" SelectedValue='<%# Bind("VehicleCode") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .9); color: rgba(59,141,65,.819);">
                                                <asp:ListItem Value="">- Select -</asp:ListItem>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:CheckBox ID="VehicleStatusCheckBox" CssClass="form-control" runat="server" Checked='<%# Bind("VehicleStatus") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .9); color: rgba(59,141,65,.819);"/>
                                        </div>
                                    </div>
                                </div>

                                <h5 class="new-vehicle-headers"><strong>Vehicle Maintenance</strong></h5>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="RegExpiryTextBox" CssClass="form-control" TextMode="Date" runat="server" Text='<%# Bind("RegExpiry") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .9); color: rgba(59,141,65,.819);"/>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="DueMileageTextBox" CssClass="form-control" runat="server" Text='<%# Bind("DueMileage") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .9); color: rgba(59,141,65,.819);"/>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="DesignatedOperatorTextBox" CssClass="form-control" runat="server" Text='<%# Bind("DesignatedOperator") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .9); color: rgba(59,141,65,.819);"/>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="PhoneNumberTextBox" CssClass="form-control" runat="server" Text='<%# Bind("PhoneNumber") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .9); color: rgba(59,141,65,.819);"/>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="DDLVehicleLocation" CssClass="form-control" runat="server" SelectedValue='<%# Bind("VehicleLocation") %>' style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(0, 1, 1, .9); color: rgba(59,141,65,.819);">
                        ...
                        <asp:LinkButton ID="InsertButton" CssClass="btn btn-success btn-lg" runat="server" CausesValidation="True" CommandName="Insert" Text="Add Vehicle" style="border-radius:10px 10px; border: none; box-shadow: 5px 5px 10px 0 #000000; background-color: rgba(59,141,65,.819);"/>
                    </div>
                </InsertItemTemplate>
            </asp:FormView>
